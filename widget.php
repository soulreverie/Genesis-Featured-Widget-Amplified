 ...
 *      Add option to link/not link post title (v0.7) Complete
 *      Add option to link/not link post image (v0.7) Complete
 *      Fix tag archive link (v0.7) Complete
 *      Fix All %taxonomy% not showing "selected" (v0.7) Complete
 *      Fix exclude post by ID not working (v0.7) Complete
...
class Genesis_Featured_Widget_Amplified extends WP_Widget {
    ...
    function widget( $args, $instance ) {
        ...
        if ( !empty( $instance['more_from_category'] ) && !empty( $posts_term['1'] ) ) {
     ...
     <div style="float: left; width: 250px; margin-left: 10px;">
         <div style="background: #f1f1f1; border: 1px solid #DDD; padding: 10px 10px 0px 10px;">
             ...
             <p><input class="widget-control-save" id="<?php echo $this->get_field_id( 'show_image' ); ?>" type="checkbox" name="<?php echo $this->get_field_name( 'show_image' ); ?>" value="1" <?php checked( 1, $instance['show_image'] ); ?>/> <label for="<?php echo $this->get_field_id( 'show_image' ); ?>"><?php _e( 'Show Featured Image', GFWA_TEXTDOMAIN ); ?></label></p>
                    ...
                    <p style="<?php gfwa_display_option( $instance, 'show_image' ); ?>"><input id="<?php echo $this->get_field_id( 'link_image' ); ?>" type="checkbox" name="<?php echo $this->get_field_name( 'link_image' ); ?>" value="1" <?php checked( 1, $instance['link_image'] ); ?>/> <label for="<?php echo $this->get_field_id( 'link_image' ); ?>"><?php _e( 'Link Image to Post', GFWA_TEXTDOMAIN ); ?></label></p>
...
?>
    ...
    <div style="background: #f1f1f1; border: 1px solid #DDD; padding: 10px 10px 0px 10px; margin-top: 10px;">
        ...
        <p style="<?php gfwa_display_option( $instance, 'show_title' ); ?>"><input id="<?php echo $this->get_field_id( 'link_title' ); ?>" type="checkbox" name="<?php echo $this->get_field_name( 'link_title' ); ?>" value="1" <?php checked( 1, $instance['link_title'] ); ?>/> <label for="<?php echo $this->get_field_id( 'link_title' ); ?>"><?php _e( 'Link Title to Post', GFWA_TEXTDOMAIN ); ?></label></p>
    ...
    <div style="<?php gfwa_display_option( $instance, 'post_type', 'page' ); ?> background: #f1f1f1; border: 1px solid #DDD; padding: 10px 10px 0px 10px; margin: 10px 0;">
     ...
     <div style="background: #f1f1f1; border: 1px solid #DDD; padding: 10px 10px 0px 10px; margin: 10px 0;">
        ...
        <p><label for="<?php echo $this->get_field_id( 'custom_field' ); ?>"><?php _e( 'Instance Identification Field', GFWA_TEXTDOMAIN ); ?>:</label>
